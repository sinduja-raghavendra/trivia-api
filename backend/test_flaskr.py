...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = 'postgresql://trivia_user@localhost:5432/trivia_test'
    ...
    def test_create_new_question_with_error_422(self):
        res = self.client().post('/questions', json=self.new_question_without_answer)
        data = json.loads(res.data)
    ...
    def test_with_400_get_questions_based_on_category(self):
